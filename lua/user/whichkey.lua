...
lvim.builtin.which_key.mappings["t"] = {
  name = "ﭧ Test",
  f = {
    "<cmd>lua require('neotest').run.run({vim.fn.expand('%'), env=require('user.neotest').get_env()})<cr>",
    "File",
  },
  o = { "<cmd>lua require('neotest').output.open({ enter = true, short = false })<cr>", "Output" },
  r = { "<cmd>lua require('neotest').run.run({env=require('user.neotest').get_env()})<cr>", "Run" },
  a = { "<cmd>lua require('user.neotest').run_all()<cr>", "Run All" },
  c = { "<cmd>lua require('user.neotest').cancel()<cr>", "Cancel" },
  R = { "<cmd>lua require('user.neotest').run_file_sync()<cr>", "Run Async" },
